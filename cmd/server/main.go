...
func main() {
	...
	if configHandler != nil {
		...
		mux.HandleFunc("/config/env/resolve", configHandler.ResolveEnvVarsHandler())
		...
		mux.HandleFunc("/config/inherit", configHandler.SetInheritanceHandler())
		mux.HandleFunc("/config/inherit/chain", configHandler.GetInheritanceChainHandler())
		mux.HandleFunc("/config/validate", configHandler.ValidateConfigHandler())
		mux.HandleFunc("/config/validate/advanced", configHandler.AdvancedValidateHandler())
		mux.HandleFunc("/config/validate/all", configHandler.ValidateAllHandler())
		mux.HandleFunc("/config/validate/deployment", configHandler.DeploymentReadinessHandler())
